...
from build import get_connection_uid
from recent_projects import Project, read_projects_from_file, \
...
class Unittests(unittest.TestCase):
    ...
    def test_items_with_vars(self):
        item1 = AlfredItem("Item 1", "item 1 subtitle", "item 1 arg")

        test = AlfredOutput([item1], {"var_key": "var_value"}).to_json()

        expected = json.dumps({"variables": {"var_key": "var_value"},
                               "items": [
                                   {"title": "Item 1",
                                    "subtitle": "item 1 subtitle",
                                    "arg": "item 1 arg",
    ...
    def test_get_connection_uid(self):
        data = b"""<?xml version="1.0" encoding="UTF-8"?>
                        ...
                        <dict>
                            <key>uidata</key>
                            <dict>
                                <key>85F05EED-52E7-4C02-8B69-80D5AFC24C4D</key>
                                <dict>
                                    <key>note</key>
                                    <string>Main connection</string>
                                    <key>xpos</key>
                                    <real>360.0</real>
                                    <key>ypos</key>
                                    <real>765.0</real>
        ...
        result = get_connection_uid(plist)

        self.assertEqual("85F05EED-52E7-4C02-8B69-80D5AFC24C4D", result)
